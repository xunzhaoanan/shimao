            ...
            <form novalidate name="myform">
              <div class="form-group margin-bottom10 clearfix">
               ...
               <div class="form-group margin-bottom10 clearfix">
                ...
                <div class="col-xs-9">
                  <span>广东省微商户独家代理</span><a class="margin-left25">修改</a>
                 <!--  <input  type="text" class="css col-sm-3" ng-readonly="isnew" required name="name"  ng-maxlength="10"> -->
                </div>
              </div>
              ...
              <div class="form-group margin-bottom10 clearfix">
               ...
               <div class="form-group margin-bottom10 clearfix">
                ...
                <div class="col-xs-9">
                  <input  type="text" class="css col-sm-3" ng-readonly="isnew" required name="name"  ng-maxlength="20"><span>@shangjiahouzuiming</span>
                </div>
              </div>
              ...
              <div class="form-group margin-bottom10 clearfix">
                ...
                <div class="col-xs-9">
                  <button class="btn btn-primary" ng-click="save()" id="submit">提交</button>
                </div>
              </div>
            </form>
          </div>
