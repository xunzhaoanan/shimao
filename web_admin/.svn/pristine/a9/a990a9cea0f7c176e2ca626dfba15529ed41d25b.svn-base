...
<div class="sidebar sidebar-fixed" id="sidebar">
    ...
    ?>
                ...
                $scope.leftArray = [
                    <?php
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['terminal_manage'])) echo "{href: '', text: '终端店管理', class: 'icon-dailishang newicon-font', isshow: true, child: [";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/terminal/list'])) echo "{href: '/terminal/list', text: '终端店列表', class: 'icon-pie-chart', child: []},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['terminal_manage'])) echo "]},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['terminaldata_manage'])) echo "{href: '', text: '终端店统计', class: 'icon-dailishang newicon-font', isshow: true, child: [";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/data/order-shop'])) echo "    {href: '/data/order-shop', text: '订单统计', class: 'icon-line-chart', child: []},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/data/member-shop'])) echo "    {href: '/data/member-shop', text: '客户统计', class: 'icon-pie-chart', child: []},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/data/fx-shop'])) echo "    {href: '/data/fx-shop', text: '推广统计', class: 'icon-pie-chart', child: []},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['terminaldata_manage'])) echo "]},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['agent_manage'])) echo "{href: '', text: '代理商管理', class: 'icon-dailishang newicon-font', isshow: true, child: [";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/agent/list'])) echo "    {href: '/agent/list', text: '代理商列表', class: 'icon-pie-chart', child: []},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['agent_manage'])) echo "]},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['data_manage'])) echo "{href: '', text: '数据中心', class: 'icon-shuju newicon-font', isshow: true, child: [";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/data/agent-order-agent'])) echo "    {href: '/data/agent-order-agent', text: '订单统计', class: 'icon-shopping-cart'},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/data/agent-order-detail'])) echo "    {href: '/data/agent-order-detail', text: '订单明细统计', class: 'icon-shopping-cart'},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/data/agent-member-agent'])) echo "    {href: '/data/agent-member-agent', text: '客户统计', class: 'icon-shopping-cart'},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/data/agent-member-detail'])) echo "    {href: '/data/agent-member-detail', text: '客户明细统计', class: 'icon-shopping-cart'},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/data/agent-fx-agent'])) echo "    {href: '/data/agent-fx-agent', text: '推广统计', class: 'icon-shopping-cart'},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['/data/agent-fx-detail'])) echo "   {href: '/data/agent-fx-detail', text: '推广明细统计', class: 'icon-shopping-cart'},";
                    if(isset(Session::get(Session::SESSION_KEY_MENU)['data_manage'])) echo "]},";
                    ?>
                ];
            }
