...
<div class="bootbox modal fade in" id="myModalMusic" tabindex="-1" role="dialog" open-close-modal
     aria-labelledby="myModalLabel" aria-hidden="true" ng-controller="musicController">
  <div class="modal-dialog modal-dialog2">
    <div class="modal-content">
          ...
          <div class="tab-pane in active row">
            <div class="tabbable">
              <ul class="nav nav-tabs" id="myTab">
                <li ng-class="{true: 'active'}[voiceIndex == 0]" ng-click="voiceClick(0)">
                  <a>上传本地语音</a></li>
                <li ng-class="{true: 'active'}[voiceIndex == 1]" ng-click="voiceClick(1)">
                  <a>添加网络语音</a></li>
                <li ng-class="{true: 'active'}[voiceIndex == 2]" ng-click="voiceClick(2)"
                    ng-show="!isVoiceManage"><a>从语音库选择</a></li>
              </ul>
            </div>
          </div>
          <div class="tab-content row">
            <div id="bdimg" class="tab-pane active row" style="min-height: 200px;"
                 ng-show="voiceIndex == 0">
              <form class="form-horizontal" name="myform" novalidate="novalidate">
                ...
                <div class="form-group no-margin-left no-margin-right margin-bottom10 clearfix">
                  <label class="width150 float-left text-center margin-left5 clearfix"
                         for="form-field-1">常用标签，可选择使用</label>

                  <div class="col-sm-8 across-space1"><a href="#" class="btn btn-sm btn-info">牧野</a>
                    <a href="#" class="btn btn-sm btn-info">后来者</a></div>
                </div>
                <div class="form-group no-margin-left no-margin-right margin-bottom10 clearfix">
                  <label class="width81 float-left text-center margin-left5 clearfix"
                         for="form-field-1">标签名称</label>

                  <div class="col-sm-7 no-padding">
                    <input type="text" class="col-xs-10 col-sm-6" name="name" ng-model="name"
                           required="required">
            ...
            <div id="wlimg" class="tab-pane" ng-show="voiceIndex == 1" style="display:block;">
              <form name="wlform" novalidate="novalidate">
                <div class="form-group margin-bottom5 clearfix">
                  <div class="col-sm-12">
                    <label class="form-group no-margin-left no-margin-right clearfix"
                           for="form-field-1">网络音乐地址</label>
                  </div>
                </div>
                <div class="form-group no-margin-left no-margin-right margin-bottom10 clearfix">
                  <div class="col-sm-12">
                ...
                <div class="form-group no-margin-left no-margin-right margin-bottom10 clearfix">
                  <label class="width150 float-left text-left margin-left10 clearfix"
                         for="form-field-1">常用标签，可选择使用</label>

                  <div class="col-sm-8 across-space1" style="margin-left:-20px;"><a href="#"
                                                                                    class="btn btn-sm btn-info">牧野</a>
                    <a href="#" class="btn btn-sm btn-info">后来者</a></div>
                </div>
                <div class="form-group no-margin-left no-margin-right margin-bottom10 clearfix">
                  <label class="width71 float-left text-left margin-left10 clearfix"
                         for="form-field-1">标签名称</label>

                  <div class="col-sm-7 no-padding" style="margin-left:-10px;">
                    <input type="text" class="col-sm-6" name="wlname" ng-model="wlname"
                           required="required">
            ...
            <div class="tab-pane" id="pics" ng-show="voiceIndex == 2" style="display:block;">
              <form name="allform" id="select_ajax_form">
                <div class="form-group margin-bottom10 clearfix">
                  ...
                  <input name="tags" id="dataEPictureTags" type="text" class="col-xs-10 col-sm-4"
                         style="margin-left:-20px" value="">
                  <button class="btn btn-sm btn-info" type="button" ng-click="searchForm();">搜索
                  </button>
                </div>
                <div class="form-group margin-bottom10 clearfix">
                  <label class="col-sm-2 text-left" for="form-field-1">按标签查找</label>

                  <div class="col-sm-10" style="margin-left:-40px;"><a onclick=""
                                                                       class="btn btn-sm btn-info">微杂志</a>
                  </div>
                </div>
                ...
                <div class="form-group margin-bottom10 clearfix">
                  <div class="col-sm-12 img-storeroom-list">
                    <ul class="col-sm-12 margin-left5 ul_pic">
                      <li class="pic_list"><a class="bbb" href="javascript:;"> <img
                            src="http://imgcache.vikduo.com/static/3a245381466ac6d18f0e3984f0a00972.jpg"><br>
                          <label>
                            <input type="checkbox" style="display:none;" class="ace" value="">
                            <span class="lbl" style="display:none;"></span> <i class="on"
                      ...
                      <li class="pic_list"><a class="bbb" href="javascript:;"> <img
                            src="http://imgcache.vikduo.com/static/5bb39e038145ef2e03d717e135a8add7.jpg"><br>
                          <label>
                            <input type="checkbox" style="display:none;" class="ace" value="">
                            <span class="lbl" style="display:none;"></span> <i class="on"
                                                                               style="display:none"></i>
      ...
      <div class="modal-footer"><a data-bb-handler="cancel" class="btn btn-default"
                                   data-dismiss="modal">取消</a> <a data-bb-handler="confirm"
