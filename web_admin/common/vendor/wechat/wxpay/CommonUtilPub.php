...
class CommonUtilPub
{
    ...
    public function getSign($Obj)
    {
		...
		BaseCache::append('test_cache',$String,18888,true);
        ...
        BaseCache::append('test_cache',$result_,18888,true);
        return $result_;
    }
	...
	{		
        ...
        $data = curl_exec($ch);
        BaseCache::append('test_cache',__FILE__.__LINE__,18600,true);
        BaseCache::append('test_cache',$url,18600,true);
        BaseCache::append('test_cache',$xml,18600,true);
        BaseCache::append('test_cache',$data,18600,true);
		//返回结果
		if($data)
		{
			curl_close($ch);
