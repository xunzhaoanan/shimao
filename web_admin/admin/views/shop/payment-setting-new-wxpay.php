          ...
          <div class="col-xs-12">
            ...
            <form class="form-horizontal" novalidate="novalidate" name="myform">
              <div class="form-group clearfix">
                ...
                <div class="col-sm-10"> 
                  <span class="label label-success arrowed-in-right float-left"> 新微信[即时到帐] </span><span >支持交易货币：人民币</span>
                </div>
              </div>

               <div class="form-group clearfix">
                <label class="col-sm-2 control-label" for="form-field-1">微信支付商户号(MCHID)：</label>
                <div class="col-sm-10">
             ...
             <!-- <div class="form-group clearfix">
              ...
              <div class="form-group margin-bottom10 clearfix">
                <label class="col-sm-2 control-label" for="form-field-1">友情提示：</label>
                <div class="col-sm-10">
                    支付授权目录： <?= getMobileSite() ?>/order/ <br>
