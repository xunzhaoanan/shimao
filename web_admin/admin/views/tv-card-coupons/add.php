                  ...
                  <div class="card_box" id="myTab">
                    <div class="card_hbg bgColor" data-toggle="tab" href="#cardset0"
                      ...
                      <div class="card_hlogo pointer">
                        <a class="card_setbtn">
                          <span class="merchants_logo"> <img ng-src="{{logo_url}}" width="100%"
                                                             height="100%"
                                                             ng-show="logo_url"/> <span
                              class=" text-center block white" style="line-height:38px;">logo</span></span>
...
.deleted != 3">下架
                  ...
                  <div class="card_setcont clearfix">
                    ...
                    <ng-form class="form-horizontal" name="form3">
                      <div class="form-group margin-bottom10">
                        ...
                        <div class="col-sm-10">
                          <textarea class="col-sm-6 form-control minheight-200px" id="form-field-8" ng-model="description" name="description" required reg-char-len="300" ng-trim="true" prompt-type="2" prompt-msg="descmsg"></textarea>
                ...
                <div id="cardset3" class="tab-pane">
                  <div class="card_setcont clearfix">
                    ...
                    <!--my-check-box="[2,1]" ng-click="cardTypeFun()"><span class="lbl">用户领取后同步到微信卡包 </span>-->
                    <!--</label>-->
...
//    }
    ...
    function getData(int, cardtype) {
      ...
      $http.post('/tv-card-coupons/shop-sub-list-ajax', datas).
        success(function (msg) {
          wsh.successback(msg, "", false, function () {
    ...
    $scope.saveBtnAdd = function () {
      ...
      $http.post('/tv-card-coupons/add-ajax', data_save).
        success(function (msg) {
