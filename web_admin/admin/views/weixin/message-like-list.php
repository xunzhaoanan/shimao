          ...
          <div class="col-xs-12"> 
            ...
            <div class="weixinmenu_top">
              ...
              <div>
                ...
                <p class="wxmenu_sm"> 通过编辑和发布自定义菜单来进行便携管理，如具备开发能力，可更灵活地使用该功能。<a href="" data-toggle="modal" data-target="#myModal2">查看详情</a> <a href="" class="btn btn-danger margin-left10" data-toggle="modal" data-target="#myModal3">停用</a> <a href="" data-toggle="modal" data-target="#myModal4" class="btn btn-success margin-left10" style="display:none;">启用</a> </p>
            ...
            <div class="table-responsive wxmenumain clearfix">
              <div class="wxmenu_cont clearfix">
                <div class="wxmenu_left">
                    ...
                    <div>
                    	<dl>
                            <dt class="selectwx"><a href=""><em class="icon-caret-right"></em> 4个汉字或8个字母<i class="icon-pencil"></i><i class="icon-trash"></i><i class="icon-plus"></i></a></dt>
                      
                            <dd><a href="">8个汉字或16个字母<i class="icon-pencil"></i><i class="icon-trash"></i></a></dd>
                            <dd><a href="">微商城子菜单2<i class="icon-pencil"></i><i class="icon-trash"></i></a></dd>
                            <dd><a href="">微商城子菜单<i class="icon-pencil"></i><i class="icon-trash"></i></a></dd>
                        </dl>
                        <dl>
                            <dt><a href=""><em class="icon-caret-right"></em> 微商城1<i class="icon-pencil"></i><i class="icon-trash"></i><i class="icon-plus"></i></a></dt>
                            <dd><a href="">微商城子菜单1<i class="icon-pencil"></i><i class="icon-trash"></i></a></dd>
                            <dd><a href="">微商城子菜单2<i class="icon-pencil"></i><i class="icon-trash"></i></a></dd>
                            <dd><a href="">微商城子菜单<i class="icon-pencil"></i><i class="icon-trash"></i></a></dd>
                        </dl>
                        <dl>
                      ...
                      <div class="index_main_box">
                        ...
                        <div class="table_box">
                            ...
                            <dl class="dl-horizontal control_group">
                              ...
                              <dt>关键词：</dt>
                              <dd>
                                <input type="text" id="keyword" name="keyword" readonly="readonly" value="" >
                                <input type="button"  value="关联" id="guanlian" class="btn_key btn btn-success width-80px"/>
                              </dd>
                              <dt>
                              回复类型：
                              </dt>
                            ...
                            <div class="inputbox_group">
                              ...
                              <div class="wx_foot wx_test_box">
                                <input type="submit" class="btn_key btn btn-success width-80px" value="保存">
                                <button class="btn_key btn btn-success width-150px" type="button" id="publish" >微信菜单发布</button>
            ...
            <div class="text-center margin-top20"><a id="post" href="#" class="btn btn-success width-160px">发布</a></div>
          </div>
        </div>
      </div>
      <!-- /.col --> 
...
<!--弹窗-->
<div class="bootbox modal fade in"  id="myModal2" tabindex="-1" role="dialog" open-close-modal aria-labelledby="myModalLabel" aria-hidden="true" >
      ...
      <div class="modal-body">
        <div class="bootbox-body">
          <div class="showinfor hintmain">
            ...
            3. 阅读接入指南接口文档，并在开发者中心设置回调URL和Token,以接收自定义菜单的开发者事件推送 </div>
        </div>
      </div>
      <div class="modal-footer"> <a href="#" data-bb-handler="cancel" class="btn btn-success">我知道了</a></div>
    </div>
  </div>
</div>
<!--选择素材-->

<div class="bootbox modal fade in"  id="myModal5" tabindex="-1" role="dialog" open-close-modal aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog width90">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <iframe width="100%" height="600px" frameborder="0" scrolling="auto" src="sucai.php" ></iframe>
