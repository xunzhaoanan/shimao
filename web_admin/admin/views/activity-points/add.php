        ...
        <div class="row">
          <div class="col-xs-12">
              ...
              <div class="form-group clearfix">
                ...
                <div class="col-sm-10">
                  ...
                  <span class="inline padding5 red"
                        ng-show="myform.name.$error.required && isSubmit">必填项</span></div>
              </div>
              <div class="form-group clearfix">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="input-group col-sm-2 no-padding">
                    <input type="text" name="start" id="end_time"
                           ...
                           value=""/>
                    <span class="input-group-addon"> <i class="icon-calendar"></i> </span></div>
                  <span class="inline paddint5 red" ng-show="isTimes">必填项</span> <span
              ...
              <div class="form-group clearfix">
                ...
                <div class="col-sm-8">
                  <div class="col-sm-3 no-padding width150">
                    <input type="text" class="col-sm-6 aaa"
                           ng-model="model.pointsConsumption.amount" name="aumout" required
                           ng-pattern="" reg-money>
                    <span class="lbl padding5 width51 inline">元，送</span> <span
                      class="inline padding5 red"
                      ng-show="myform.aumout.$error.required && isSubmit">必填项</span> <span
                      class="inline padding5 red" ng-show="myform.aumout.$error.pattern">{{$root.regMoneyText}}</span>
                  </div>
                  <div class="col-sm-3 no-padding width150">
                    <input type="text" class="col-sm-6" maxlength="7"
                           ng-model="model.pointsConsumption.points" name="points" required
                           ng-pattern="" reg-int>
                    <span class="lbl padding5 width51 inline">积分</span></div>
                  <span class="inline padding5 red"
                        ng-show="myform.points.$error.required && isSubmit">必填项</span> <span
                    class="inline padding5 red" ng-show="myform.points.$error.pattern">{{$root.regIntText}}</span>
                </div>
              </div>
              <div class="form-group clearfix">
            ...
            <div class="modal-footer margin-auto" id="modal-footer"><a class="btn btn-infor"
              ...
              返回 </a> <a ng-disabled="isDisabled" class="btn btn-primary " ng-click="btnSava()">
              保存 </a></div>
          </div>
        </div>
      </div>
...
<script>
  app.controller("mainController", function ($scope, $rootScope, $timeout, $http) {
    ...
    $scope.model.activity.expire_type = 2;
    $scope.expireOption = [
      {"id": 2, "title": "无时间限制"},
      {"id": 1, "title": "指定时间有效"}
    ];
    ...
    //活动策略
    $scope.model.pointsConsumption = {};
    $scope.model.pointsConsumption.type = 2;
    $scope.model.pointsConsumption.count_type = 1;
    $scope.policyOption = [
      {"id": 2, "title": "订单满多少送积分"},
    ...
    $scope.btnSava = function () {
      ...
      $http.post(wsh.url + "add-ajax", {
        ...
        "pointsConsumption": {
          ...
          "amount": $scope.model.pointsConsumption.amount * 100,//满多少元
