...
<div class="sidebar sidebar-fixed" id="sidebar"> 
  ...
  <script>
    ...
    $scope.leftArray = [
             {href: '/wxmaterial/news-list', text: '素材管理', class: 'icon-sucai newicon-font', isshow: false, key: 'ba'},
             {href: '/weixin/keyword-reply-list', text: '回复管理', class: 'icon-huifu newicon-font', isshow: false, key: 'bb'},
             {href: '/weixin/diymenu', text: '自定义菜单', class: 'icon-zidingyicaidan newicon-font', isshow: false, key: 'bc'},
             {href: '/weixin/message-list', text: '消息管理', class: 'icon-huifu newicon-font', isshow: false, key: 'bd'},
    ];
    $scope.leftArray = $rootScope.headList.b.child;
    ...
    $rootScope.$on('leftMenuChange', function(e, id){
      ...
      for(var i = 0;  i< $('#headactive li').length; i++ ){
        if($('#headactive li').eq(i).find('a').text() == '微信设置'){
          index = i;
        }
      }
