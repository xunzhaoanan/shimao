                  ...
                  <form class="form-horizontal" role="form">
                    <table width="100%"
                      ...
                      <tr ng-repeat="list in lists">
                        <td class="text-center" ng-bind="list.username ? list.username : list.wxUserInfos.nickname"></td>
                        ...
                        <td class="text-center pointer" ng-if="list.exchange==2"><a ng-click="exchange($index)">手动兑换</a></td>
                      </tr>
                      </tbody>
                      <tr>
    ...
    app.controller("mainController", function ($scope, $rootScope, $timeout) {
     ...
     //导出
      $scope.export = function () {
        ...
        window.open("/export/market-activity?template=4&id=" + $scope.model.id + "&findName=" + findName + "&level=" + level);
      };

     //兑奖
      $scope.exchange = function (index) {
        $.post('<?= Url::to(["market-activity/smashegg-exchange-record-ajax"]);?>',
        {
