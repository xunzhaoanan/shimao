...
;(function($, window, document, undefined) {
    ...
    var pluginName = 'abixTreeList',
        defaults = {
            collapsedIconClass  : 'icon-plus img-fl-space5',
            expandedIconClass   : 'icon-minus img-fl-space5'
        };
    ...
    Plugin.prototype.expand = function($branch) {
        var self = this;
        $branch.children('ul,ol').children('li').slideDown(500, function() {
    ...
    Plugin.prototype.collapse = function($branch) {
        var self = this;
        $branch.children('ul,ol').children('li').slideUp(500, function() {
    ...
    Plugin.prototype.collapseAll = function() {
        var self = this;
        self.$allBranches.not(self.$topLevelBranches).slideUp(1000, function() {
    ...
    Plugin.prototype.expandAll = function() {
        var self = this;
        self.$allBranches.slideDown(1000, function() {
