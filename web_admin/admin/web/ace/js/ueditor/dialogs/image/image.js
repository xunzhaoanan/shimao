  ...
  OnlineImage.prototype = {
    ...
    getImageData: function () {
      ...
      if (!_this.listEnd && !this.isLoadingData) {
        ...
        var url = '/document/image-ajax',
          isJsonp = utils.isCrossDomainUrl(url);
        ajax.request(url, {
          'timeout': 100000,
          'dataType': isJsonp ? 'jsonp' : '',
          'data': utils.extend({
            _page: this.listIndex + 1,
            _page_size: 15
          ...
          'onsuccess': function (r) {
            try {
              ...
              if (json.errcode == '0') {
                _this.pushData(json.errmsg.data);
                _this.listIndex = parseInt(json.errmsg.page.current_page) + 1;
                if (_this.listIndex >= json.errmsg.page.total_page) {
                  _this.listEnd = true;
                }
    ...
    pushData: function (list) {
      ...
      for (i = 0; i < list.length; i++) {
        if (list[i] && list[i].file_cdn_path) {
          ...
          img.width = 113;
          img.setAttribute('src', list[i].file_cdn_path);
          img.setAttribute('_src', list[i].file_cdn_path);
